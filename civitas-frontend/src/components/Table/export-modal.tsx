    ...
    <Modal setValue={onClose} value={open}>
      <div className="space-y-6">
        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,240px)_minmax(0,1fr)]">
          <section className="civitas-card-soft p-4">
          ...
          <section className="civitas-surface-subtle p-4">
            ...
            {!hasSelectedColumns ? (
              <p className="mt-3 text-sm font-medium text-[var(--tone-danger-text)]">
        ...
        <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
          <button
            ...
            className="civitas-action civitas-action--ghost px-5 py-3 font-semibold disabled:cursor-not-allowed disabled:opacity-60"
          >
            Cancelar
          </button>
          <button
            ...
            className="civitas-action civitas-action--primary px-5 py-3 font-semibold disabled:cursor-not-allowed disabled:opacity-60"
          >

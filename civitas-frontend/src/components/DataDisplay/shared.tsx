...
export const toneClasses: Record<InfoTone, string> = {
  default:
    "border-[var(--border-soft)] bg-[var(--surface-elevated)] text-[var(--foreground)]",
  teal:
    "border-[var(--tone-teal-border)] bg-[var(--tone-teal-bg)] text-[var(--tone-teal-text)]",
  amber:
    "border-[var(--tone-amber-border)] bg-[var(--tone-amber-bg)] text-[var(--tone-amber-text)]",
  slate:
    "border-[var(--tone-slate-border)] bg-[var(--tone-slate-bg)] text-[var(--tone-slate-text)]",
  coral:
    "border-[var(--border-accent-coral)] bg-[var(--surface-accent-coral)] text-[var(--text-accent-coral)]",
  success:
...
export const relatedGridClasses: Record<
  NonNullable<RelatedItemsSectionProps["columns"]>,
  string
> = {
  1: "grid-cols-1",
...
export const isEmptyNode = (value: React.ReactNode) =>

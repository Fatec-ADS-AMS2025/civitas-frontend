...
export default function InstituicaoCodigoResumoCard({ codigo }: InstituicaoCodigoResumoCardProps) {
  return (
    <article className="rounded-sm border border-[var(--border-soft)] bg-[var(--surface-subtle)] p-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--foreground-soft)]">Codigo</p>
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <div className="rounded-sm border border-[var(--border-soft)] bg-[var(--surface-elevated)] p-3">
          <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[var(--foreground-soft)]">Total</p>
          <p className="mt-2 text-base font-semibold text-[var(--foreground)]">{codigo.totalGastosFormatado}</p>
        </div>
        <div className="rounded-sm border border-[var(--border-soft)] bg-[var(--surface-elevated)] p-3">
          <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[var(--foreground-soft)]">
            Ultima referencia
          </p>
          <p className="mt-2 text-base font-semibold text-[var(--foreground)]">{codigo.ultimaReferenciaFormatada}</p>
        </div>
      </div>
    </article>
  );

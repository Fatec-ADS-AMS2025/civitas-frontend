...
type FornecedorPageClientProps = {
  initialPage: PaginatedResult<Fornecedor>;
...
export default function FornecedorPageClient({
  ...
  const [paginationState, setPaginationState] = useState<PaginationState>({
    currentPage: initialRowsPage.currentPage,
    pageSize: initialRowsPage.pageSize,
    totalPages: initialRowsPage.totalPages,
    totalRecords: initialRowsPage.totalRecords,
  });
  const [currentPage, setCurrentPage] = useState(initialRowsPage.currentPage);
  const [pageSize, setPageSize] = useState(initialRowsPage.pageSize);

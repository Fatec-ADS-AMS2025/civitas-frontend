  ...
  return (
    <section className="financeiro-hero civitas-surface civitas-enter p-5 lg:p-6">
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-[1fr_280px]">
        <div>
          <div className="financeiro-hero__badge inline-flex items-center gap-2 rounded-sm border border-[var(--border-default)] bg-[var(--surface-subtle)] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.08em] text-[var(--foreground-soft)]">
            Modulo financeiro
            <span className="h-2 w-2 rounded-sm bg-[var(--primary-2)]" />
          </div>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            <span className="financeiro-hero__tag inline-flex items-center gap-1.5 rounded-sm border border-[var(--border-soft)] bg-[var(--surface-subtle)] px-3 py-1.5 text-[11px] font-medium text-[var(--foreground)]">
              Ultima atualizacao: {ultimaMovimentacao}
            </span>
            <span className="financeiro-hero__tag inline-flex items-center gap-1.5 rounded-sm border border-[var(--border-default)] bg-[var(--surface-elevated)] px-3 py-1.5 text-[11px] font-medium text-[var(--secundary-1)]">
        ...
        <div className="flex flex-col gap-3">
          <div className="financeiro-hero__stat rounded-sm border border-[var(--border-soft)] bg-[var(--surface-subtle)] p-4">
            <div>
